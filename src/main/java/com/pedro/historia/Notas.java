...
public class Notas {
        ...
        if(queda ==1){
            if (nota == 1) {
                ...
                UtilForMe.TempoDeLeitura("""
                    ...
                    Quanto mais sofremos, mais fortes ficam.
                    Não implore. Nunca chore. Nunca mostre esperança.
    ...
    public static String notasPersonagens(Player p) throws IOException {
        ...
        if(p.getLore().equals("Destino")){
            ...
            texto = """
                    O mundo acima nunca lhe ofereceu nada além de fome e desespero. A vida era uma sequência de promessas
            ...
            texto = """
                    Não houve julgamento. Não houve escolha. Você foi marcado, amarrado, arrastado como gado. O povo gritava
                    por justiça, mas o que eles queriam era apenas afastar o próprio medo. O vazio exige carne, e você foi a
                    carne escolhida.
                    
                    Empurrado ao abismo, seu corpo caiu em silêncio. Nem ao menos um último olhar de compaixão. Apenas o
                    peso da injustiça. Apenas a certeza de que sua vida valia menos do que o pânico coletivo.
                    
                    Agora, nos escombros da Primeira Queda, você abre os olhos. As correntes ainda marcam seus pulsos,
                    mas não há mais amarras. O que resta de você é raiva, e uma pergunta: foi mesmo azar… ou o vazio queria
                    você desde o começo?
                    """;
        } else{
            texto = """
                    Você jurou proteger a humanidade da fenda. Seu posto não era de glória, mas de vigília eterna.
                    Olhar o abismo, sem jamais entrar nele. Vigiar os portões, sem jamais cruzá-los. Essa era sua promessa.
                    
                    Mas o abismo sempre cobra. Um descuido, um empurrão, ou talvez uma escolha maldita — ninguém saberá.
                    O que importa é que a escuridão se abriu sob seus pés, e você caiu. O juramento que deveria ser sua honra tornou-se sua condenação.
                    
                    Agora, entre as sombras da Primeira Queda, você carrega não apenas sua vida, mas o peso da culpa.
                    Quem protegerá o mundo, agora que o protetor caiu? Talvez este seja seu último castigo: morrer no mesmo
                    inferno que jurou conter.
                    """;
        }
//
    ...
    public static RetornoMultiplo GetDesafio(int torre){
        String desafio;
        Random r = new Random();
        ...
        RetornoMultiplo x = new RetornoMultiplo();
        x.StringInteiro(desafio,correctAnswer);
        return x ;
    }

    public static String GetRespostaDesafio(int torreQualDesafio){
    ...
    public static String GetIntroTorre(int torre){
        String t;
        if(torre == 1){
            t = """
                    - Torre do Oeste -
    ...
    public static String GetIntroTorreInside(int torre){
        String t;
        if(torre == 1){
            t = """
                    - Torre do Oeste -
